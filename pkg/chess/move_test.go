...
func TestUCI(t *testing.T) {
	...
	t.Run("h8 promotion to queen", func(t *testing.T) {
		oCor := pkg.Coor(7, 1)
		tCor := pkg.Coor(7, 0)
		promotionPiece := pkg.White | pkg.Queen
		expected := "h7h8q"
	...
	t.Run("h8 promotion to knight", func(t *testing.T) {
		oCor := pkg.Coor(7, 1)
		tCor := pkg.Coor(7, 0)
		promotionPiece := pkg.White | pkg.Knight
		expected := "h7h8n"
	...
	t.Run("h8 promotion to bishop", func(t *testing.T) {
		oCor := pkg.Coor(7, 1)
		tCor := pkg.Coor(7, 0)
		promotionPiece := pkg.White | pkg.Bishop
		expected := "h7h8b"
	...
	t.Run("h8 promotion to rook", func(t *testing.T) {
		oCor := pkg.Coor(7, 1)
		tCor := pkg.Coor(7, 0)
		promotionPiece := pkg.White | pkg.Rook
		expected := "h7h8r"
	...
	t.Run("h1 promotion to queen", func(t *testing.T) {
		oCor := pkg.Coor(7, 6)
		tCor := pkg.Coor(7, 7)
		promotionPiece := pkg.Black | pkg.Queen
		expected := "h2h1q"
